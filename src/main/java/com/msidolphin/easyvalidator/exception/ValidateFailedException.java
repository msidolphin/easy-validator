...
package com.msidolphin.easyvalidator.exception;
...
public class ValidateFailedException extends RuntimeException {
    ...
    public ValidateFailedException(String message, String fieldName) {
        super("Failed to validate" + (CommonUtil.isNotEmpty(fieldName) ? " " + fieldName : "") + ": " + message);
    }
