...
public class IpValidator extends AbstractValidator<Object, BaseConstraint> {
    ...
    public void validate(Object value, BaseConstraint constraint) {
        ...
        if (RegexUtil.test(IPV4_PATTERN, (String) value) || RegexUtil.test(IPV6_PATTERN, (String) value)) return;
